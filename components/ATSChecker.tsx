      ...
      reader.onload = async () => {
        ...
        const response = await ai.models.generateContent({
          ...
          contents: { parts: [
            ...
            { text: `Analyze this resume against JD: ${jobDescription}. Focus on scoring and identifying specific optimization gaps. Provide JSON result.` }
          ] },
          config: {
            ...
            responseSchema: {
              ...
              properties: {
                ...
                sectionScores: {
                  type: Type.OBJECT,
                  properties: { summary: { type: Type.NUMBER }, experience: { type: Type.NUMBER }, education: { type: Type.NUMBER }, skills: { type: Type.NUMBER } },
                  required: ["summary", "experience", "education", "skills"]
                },
                issues: { type: Type.ARRAY, items: { 
                  type: Type.OBJECT,
                  properties: { title: { type: Type.STRING }, location: { type: Type.STRING }, description: { type: Type.STRING }, highlight: { type: Type.STRING }, suggestion: { type: Type.STRING }, severity: { type: Type.STRING } },
