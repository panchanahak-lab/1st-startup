        ...
        <div className="flex flex-col items-center text-center">
          ...
          <div id="hero-badge" className="animate-reveal inline-flex items-center gap-2 bg-white/10 dark:bg-white/5 border border-white/20 px-4 py-2 md:px-6 md:py-2 rounded-full mb-8 md:mb-12 shadow-xl backdrop-blur-md">
            ...
            <span className="text-[9px] md:text-[10px] font-black uppercase tracking-[0.2em] md:tracking-[0.3em] text-navy-900 dark:text-brand-400">
              India's #1 Free AI Interview Platform
            </span>
          </div>
          ...
          <p className="animate-reveal [animation-delay:200ms] text-lg md:text-xl lg:text-2xl text-slate-600 dark:text-slate-300 max-w-3xl mb-12 md:mb-16 leading-relaxed font-medium px-4">
            Master your interview skills with real-time AI simulations in <span className="text-brand-500 font-bold">all Indian languages</span>. <span className="inline-block border-b-2 border-brand-500">100% Free. Forever.</span>
          </p>
          ...
          >
            <i className="fas fa-play-circle text-lg"></i> Take a Quick Tour
          </button>
          ...
          <div className="mt-16 md:mt-24 flex flex-col md:flex-row items-center gap-6 md:gap-8 animate-reveal [animation-delay:500ms]">
            <div className="flex -space-x-3 md:-space-x-4">
              <div className="w-10 h-10 md:w-14 md:h-14 rounded-full border-2 md:border-4 border-white dark:border-navy-950 bg-slate-100 flex items-center justify-center text-xs font-bold shadow-xl">
            ...
            <div className="text-center md:text-left">
              <p className="text-sm font-black text-navy-900 dark:text-white tracking-tight leading-none mb-1">Indian Languages Supported</p>
              <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Hindi, Marathi, Tamil, Telugu & more</p>
            </div>
          </div>
        </div>
      </div>
