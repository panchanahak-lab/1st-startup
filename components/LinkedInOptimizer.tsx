...
const LinkedInOptimizer: React.FC = () => {
  ...
  const handleOptimize = async () => {
    ...
    try {
      ...
      const parts: any[] = [
        { text: `Act as a top-tier Executive Career Coach and LinkedIn Branding Expert. 
      ...
      if (screenshot) {
        ...
        parts[0].text += `\nI have also attached a screenshot of the current profile. Analyze the visual branding, profile picture placement, banner effectiveness, and layout.`;
      }
      ...
      const response = await ai.models.generateContent({
        ...
        config: {
          ...
          responseSchema: {
            type: Type.OBJECT,
            properties: {
              executiveSummary: { type: Type.STRING, description: "A high-level 2-3 sentence overview of the analysis and the single most important recommendation." },
              headlines: {
                type: Type.OBJECT,
                properties: {
              ...
              outreachScripts: {
                ...
                items: {
                  type: Type.OBJECT,
                  properties: {
                    type: { type: Type.STRING, description: "e.g., 'To Recruiter', 'To Peer'" },
