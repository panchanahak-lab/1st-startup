      ...
      >
        <div className="w-[380px] max-w-[94vw] bg-white dark:bg-navy-900 rounded-[2.5rem] p-8 md:p-10 border border-slate-200 dark:border-white/10 shadow-[0_50px_100px_-20px_rgba(0,0,0,0.8)] relative">
          ...
          {tooltipPos.arrow !== 'none' && (
            <div className={`absolute left-1/2 -translate-x-1/2 w-4 h-4 bg-white dark:bg-navy-900 rotate-45 border-slate-200 dark:border-white/10 ${
              tooltipPos.arrow === 'top' ? '-top-2 border-t border-l' : '-bottom-2 border-b border-r'
            }`}></div>
          )}
